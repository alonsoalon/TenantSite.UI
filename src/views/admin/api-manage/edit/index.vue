      ...
      <section class="drawer-body">
        ...
        >
          <el-form-item label="分类" prop="category">
            <el-input v-model="data.category" autocomplete="off" />
          </el-form-item>
          ...
          <el-form-item label="请求方法" prop="httpMethod">
            <el-radio-group v-model="data.httpMethod">
              <el-radio-button
          ...
          <el-form-item label="权限验证" prop="isValidation">
            <el-switch v-model="data.isValidation" />
          </el-form-item>
...
// apis
import { execUpdate } from "@/api/admin/api";

export default {
  name: "admin--api-manage--edit",
  components: {
    ConfirmButton,
    GroupSelect
  },
